...
public class FilaEstaticaComDuplicacao {
    ...
    public void mergearFila(aula14_exercicios_filas_pilhas.FilaEstaticaComDuplicacao fila) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(minhaFila.estaNaFila("Leonardo"));
        System.out.println(minhaFila.estaNaFila("Bernardo"));
