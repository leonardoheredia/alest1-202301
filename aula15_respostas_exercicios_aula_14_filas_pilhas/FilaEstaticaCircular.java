...
public class FilaEstaticaCircular {
    ...
    public int posicaoNaFila(String item) {
        ...
        int cont = 0;
        while(cont<this.capacidade) {
            if(this.itens[posicao]!=null && this.itens[posicao].equals(item)) return cont;
            else {
                posicao++;
                if(posicao==this.capacidade) posicao=0;
            }
            cont++;
        }
        return -1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(minhaFila.posicaoNaFila("Tito"));
