...
public class PilhaDinamica {
    ...
    public String maiorItem() {
        ...
        Nodo n = this.base;
        do {
            if(n.item.length()>=aux.length()) aux = n.item;
            n = n.proximo;
        }while(n!=null);
        return aux;
    }
    public static void main(String[] args) {
        ...
        pilha.empilhar("Alexandra");
        System.out.println(pilha.posicaoNaPilha("Mariana"));
        System.out.println(pilha.posicaoNaPilha("Alexandre"));
        System.out.println(pilha.posicaoNaPilha("Lucas"));
        System.out.println(pilha.posicaoNaPilha("Alexandra"));
